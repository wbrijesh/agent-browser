 ...
 */
export async function executeIOSCommand(command, manager) {
    ...
    try {
        switch (action) {
            ...
            case 'tab_close':
            case 'window_new':
                return errorResponse(id, `Command '${action}' is not supported on iOS Safari. Mobile Safari does not support programmatic tab management.`);
            case 'pdf':
...
//# sourceMappingURL=ios-actions.js.map